...
export const PERMISSIONS = {
  ...
  PAYMENT_RECEIPT_MANAGE: "payment.receipt.manage",
  ...
  OWNER_WITHDRAWAL_MANAGE: "owner.withdrawal.manage",
  SUPPLIER_RECEIVE: "supplier.receive",
  SUPPLIER_QUALITY_APPROVE: "supplier.quality.approve",
  CUSTOMER_FEEDBACK_MANAGE: "customer.feedback.manage",
  COMPLAINT_MANAGE: "complaint.manage",
  REPORT_KITCHEN_VIEW: "report.kitchen.view",
  REPORT_SUPPLIER_VIEW: "report.supplier.view",
  REPORT_OPERATIONS_VIEW: "report.operations.view",
} as const;
...
const ROLE_PERMISSIONS = {
  ...
  MANAGER: [
    ...
    PERMISSIONS.PAYMENT_RECEIPT_MANAGE,
    ...
    PERMISSIONS.ATTENDANCE_SCHEDULE,
    PERMISSIONS.ATTENDANCE_RECORD,
    PERMISSIONS.ATTENDANCE_APPROVE,
    PERMISSIONS.EXPENSE_RECORD,
    PERMISSIONS.SUPPLIER_RECEIVE,
    PERMISSIONS.SUPPLIER_QUALITY_APPROVE,
    PERMISSIONS.CUSTOMER_FEEDBACK_MANAGE,
    PERMISSIONS.COMPLAINT_MANAGE,
    PERMISSIONS.REPORT_KITCHEN_VIEW,
    PERMISSIONS.REPORT_SUPPLIER_VIEW,
    PERMISSIONS.REPORT_OPERATIONS_VIEW,
  ],
  CASHIER: [
    PERMISSIONS.TABLE_MANAGE,
    PERMISSIONS.ORDER_VIEW_ALL,
  ...
  WAITER: [PERMISSIONS.ORDER_VIEW_ASSIGNED, PERMISSIONS.ORDER_CREATE, PERMISSIONS.ATTENDANCE_RECORD],
  COOK: [PERMISSIONS.KITCHEN_TICKET_VIEW, PERMISSIONS.KITCHEN_TICKET_UPDATE, PERMISSIONS.KITCHEN_QUALITY_RECORD, PERMISSIONS.OPERATIONS_INCIDENT_RECORD, PERMISSIONS.CLEANING_COMPLETE, PERMISSIONS.ATTENDANCE_RECORD],
  BARISTA: [PERMISSIONS.KITCHEN_TICKET_VIEW, PERMISSIONS.KITCHEN_TICKET_UPDATE, PERMISSIONS.KITCHEN_QUALITY_RECORD, PERMISSIONS.OPERATIONS_INCIDENT_RECORD, PERMISSIONS.CLEANING_COMPLETE, PERMISSIONS.ATTENDANCE_RECORD],
  Cabitaan: [
  ...
  SUPPLIER: [],
  CLEANER: [PERMISSIONS.TABLE_RESET_ASSIGNED, PERMISSIONS.OPERATIONS_INCIDENT_RECORD, PERMISSIONS.CLEANING_COMPLETE, PERMISSIONS.ATTENDANCE_RECORD],
