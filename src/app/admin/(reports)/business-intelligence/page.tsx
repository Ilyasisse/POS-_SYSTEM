...
const reportCards = [
  ...
  [
    "Inventory losses",
    "/admin/reports/inventory-losses",
    PERMISSIONS.REPORT_INVENTORY_VIEW,
  ],
    ...
    <main className="space-y-6 p-4 md:p-8">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          Live server-calculated reports. Coverage notes mark periods that were
          not historically recorded.
        </p>
      </header>
      ...
      <section className="rounded-lg border p-4 text-sm">
        ...
        <p className="mt-1 text-muted-foreground">
          Attendance, payroll, expenses, supplier receiving, feedback, and
          complaints are recorded as audited source data; anonymous orders
          remain anonymous.
        </p>
      </section>
    </main>
