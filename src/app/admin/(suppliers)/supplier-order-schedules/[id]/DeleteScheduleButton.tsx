    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This stops future invitations, reminders, and supplier sends.
            Existing purchase orders, responses, and WhatsApp delivery history
            will be preserved. Messages already accepted by Twilio cannot be
            recalled.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
