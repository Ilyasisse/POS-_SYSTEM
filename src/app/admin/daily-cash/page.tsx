...
import { createManualExpenseAction, deleteManualExpenseAction, finalizeDailyCashAction, overrideSalaryAction, paySalaryAction, paySupplierObligationAction, paySupplyBalanceAction } from "./actions";
...
export default async function DailyCashPage({ searchParams }: { searchParams?: Promise<{ date?: string }> }) {
  ...
  return <div className="mx-auto w-full max-w-7xl space-y-6 p-4 sm:p-6">
    <PageHeader eyebrow="Operations" title="Daily cash" description="Use waiter revenue to pay salary, prior-day supplies, supplier obligations, and one-time expenses." />
