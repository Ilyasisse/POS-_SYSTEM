      ...
      <DialogContent>
        <form onSubmit={submit} className="space-y-5">
          <DialogHeader>
            ...
            <DialogDescription>
              The item disappears from ordering screens immediately. Timed
              pauses restore automatically.
            </DialogDescription>
          </DialogHeader>
          <input type="hidden" name="id" value={productId} />
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              minLength={3}
              maxLength={200}
              placeholder="Example: chicken delivery is delayed"
              required
            />
          </div>
          {error ? (
